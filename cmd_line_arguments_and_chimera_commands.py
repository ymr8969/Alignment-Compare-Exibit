...
col_string = "%s %s %s %s %s %s novalue gray" % (max_value, max_color, mid_value, mid_color, min_value, min_color)
...
# Record movies
i = 0
out_file = "%s/%s_%s_%s_%s_%s_view_%i" % (out_folder, rID, qID, rep, attr, metric, i)
